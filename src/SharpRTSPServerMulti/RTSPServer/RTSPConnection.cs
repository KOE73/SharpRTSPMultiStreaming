...
public class RTSPConnection
{
    ...
    /// </summary>
    public uint SSRC { get; set; } = (uint)Utilities._rand.Next(0, int.MaxValue);
    ...
    {
        return $"[Uri={BaseUri}, Play={Play}, SessionId={SessionId}, " +
               $"SSRC={SSRC:X8}, Remote={Listener?.RemoteEndPoint}, " +
               $"LastKeepAlive={TimeSinceLastRtspKeepAlive:O}]";
    }
}
