...
public class H266Track : TrackBase
{
    ...
    public H266Track(string uri, int clock = DEFAULT_CLOCK): base(uri)
    {
    ...
    /// <param name="clock">H266 clock. Default value is 90000.</param>
    public H266Track(string uri, byte[] dci, byte[] vps, byte[] sps, byte[] pps, byte[] sei = null, int clock = DEFAULT_CLOCK) : this(uri, clock)
    {
